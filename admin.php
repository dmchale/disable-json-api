...
<style>
    #DRA_target ul li { padding-left: 20px; }
</style>
...
<div class="wrap">
    ...
    <form method="post" action="" id="DRA_form">
        ...
        <?php @submit_button(); ?>
        <input type="submit" name="reset" value="<?php echo __( "Reset Whitelisted Routes", "disable-json-api" ); ?>" onclick="return confirm('<?php echo __( "Are you sure you wish to clear all whitelisted rules?", "disable-json-api" ); ?>');">
    </form>
</div>
